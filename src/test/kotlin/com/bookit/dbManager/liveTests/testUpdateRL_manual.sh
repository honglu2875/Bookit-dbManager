...
curl -v -X POST http://localhost:8080/api/backend/update_refresh_token -H "Authorization: Basic $TOKEN" -H "Content-Type: application/json" -d '{"email":"'$EMAIL'","refreshToken":"'test'"}'
